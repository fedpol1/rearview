...
public class ModConfig {
    ...
    public static Screen createGui(Screen parent) {
        return YetAnotherConfigLib.createBuilder()
                .title(Component.translatable(RearviewClient.MODID + ".config"))
                .save(ModConfig::writeConfig)
                .category(ConfigCategory.createBuilder()
                        .name(Component.translatable(RearviewClient.MODID + ".config.category.misc"))
                        .option(Option.<AngleHandling>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.yaw_transform"))
                                ...
                                .build())
                        .option(Option.<AngleHandling>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.pitch_transform"))
                        ...
                        .option(Option.<AngleSource>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.yaw_source"))
                                ...
                                .build())
                        .option(Option.<AngleSource>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.pitch_source"))
                                .binding(AngleSource.SELF, () -> ModConfig.PITCH_SOURCE, v -> ModConfig.PITCH_SOURCE = v)
                                .controller(o -> EnumControllerBuilder.create(o).enumClass(AngleSource.class))
                                .build())
                        .option(Option.<Float>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.yaw_aux"))
                                .binding(0.0f, () -> ModConfig.YAW_AUX, v -> ModConfig.YAW_AUX = v)
                                .controller(FloatFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Float>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.pitch_aux"))
                                .binding(0.0f, () -> ModConfig.PITCH_AUX, v -> ModConfig.PITCH_AUX = v)
                                .controller(FloatFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.lock"))
                                .binding(false, () -> ModConfig.CAMERA_LOCK, v -> ModConfig.CAMERA_LOCK = v)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<HoldToggle>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.look_hold_toggle"))
                                ...
                                .build())
                        .option(Option.<HoldToggle>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.show_rotation_hold_toggle"))
                                .binding(HoldToggle.TOGGLE, () -> ModConfig.SHOW_ROTATION_HOLD_TOGGLE, v -> ModConfig.SHOW_ROTATION_HOLD_TOGGLE = v)
                                .controller(o -> EnumControllerBuilder.create(o).enumClass(HoldToggle.class))
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.keep_spectator_menu"))
                                .binding(false, () -> ModConfig.KEEP_SPECTATOR_MENU, v -> ModConfig.KEEP_SPECTATOR_MENU = v)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.filter_spectators"))
                                .binding(true, () -> ModConfig.FILTER_SPECTATORS, v -> ModConfig.FILTER_SPECTATORS = v)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Component.translatable(RearviewClient.MODID + ".config.sort_spectators"))
